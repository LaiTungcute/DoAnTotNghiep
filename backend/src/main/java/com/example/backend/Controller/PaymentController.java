...
import com.example.backend.Config.VNPay.Config;
...
public class PaymentController {
    ...
    @GetMapping("")
    public String getPay(@RequestParam(name = "cartId") int cartId,
                         @RequestParam(name = "address") String address,
                         @RequestParam(name = "receiver") String receiver,
                         @RequestParam(name = "phoneNumber") String phoneNumber) throws UnsupportedEncodingException {

        Cart cart = cartRepository.findById(cartId).orElseThrow(() -> new RuntimeException("Cart not found"));
        String vnp_Version = "2.1.0";
        String vnp_Command = "pay";
        String orderType = "other";
        long amount = cart.getTotalPrice()*100;
        String bankCode = "NCB";
        ...
        vnp_Params.put("vnp_ReturnUrl", Config.vnp_ReturnUrl
                                        ...
                                        +"&receiver="+receiver+"&phoneNumber"+phoneNumber);
    ...
    public void paymentCallback(@RequestParam Map<String, String> queryParams, HttpServletResponse response) throws IOException {
        ...
        String cartId = queryParams.get("cartId");
